...
class BroadcastTick extends Task {
	...
	private array $messages = ["&6&l[?]&r Do you want to buy a rank? Visit our store: &6https://pacmanlife.buycraft.net/",
		"&6&l[?]&r You can enter our discord through this link: &9invite.gg/pacmanlife",
		...
		"&4&ll[!]&r This is a BETA 2.0 version of &ePacmanlife&r, if you find any problem like a bug or glitch, please contact us at &9invite.gg/pacmanlife"
	];
	...
	private function getAllVIPPlayers() : string {
		$players = [];
