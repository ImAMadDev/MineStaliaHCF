...
class HCFPlayer extends Player {
	...
	public function getChatFormat() : string {
        ...
        $tag = $this->getCurrentTag() == null ? "" : $this->getCurrentTag()->getFormat() . " ";
		return $format . $tag . TextFormat::YELLOW;
	}
                    ...
                    if ($enchantment->getType() instanceof CustomEnchantment) {
                        if ($enchantment->getType()->canBeActivate()) {
                            ...
                            if ($this->hasEffectsActivate()) {
                                $this->applyPotionEffect($enchantment->getType()->getEffectsByEnchantment($enchantment->getWorld()));
                            }
                        }
                    }
                }
